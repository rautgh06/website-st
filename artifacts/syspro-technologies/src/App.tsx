    ...
    <div className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 lg:py-32">
      <div className="grid gap-10 lg:grid-cols-[.78fr_1.22fr] lg:items-start">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }} variants={fadeUp} className="lg:sticky lg:top-32">
         ...
         <div className="career-frame max-w-[680px] justify-self-end overflow-hidden rounded-[1.5rem] shadow-[0_24px_60px_hsl(var(--foreground)/.14)]">
           ...
           <iframe title="SysProTechnologies jobs and careers application form" src="https://docs.google.com/forms/d/e/1FAIpQLSeeyDO3MN8V5LgC9Rf8PpYs8zgEjIp6X9pYXM9zg9P-SpDA3Q/viewform?embedded=true" allowFullScreen loading="lazy" className="career-form h-[620px] w-full bg-[hsl(var(--card))] sm:h-[660px]" data-testid="iframe-careers-form" />
        </div>
      </div>
    </div>
  </section>;
