...
function Contact() {
  ...
  return <section id="contact" className="scroll-mt-20 bg-[hsl(var(--primary))]">
    <div className="mx-auto grid max-w-[1240px] gap-14 px-5 py-24 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:gap-24 lg:py-32">
      <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }} variants={fadeUp}><p className="eyebrow text-[hsl(var(--primary-foreground)/.63)]">Talk to SysPro</p><h2 className="mt-5 max-w-[500px] font-display text-5xl leading-[.93] tracking-[-.06em] text-[hsl(var(--primary-foreground))] sm:text-7xl">Let’s make<br />the next step<br /><span className="text-[hsl(var(--background))]">clear.</span></h2><p className="mt-7 max-w-[410px] text-base leading-7 text-[hsl(var(--primary-foreground)/.68)]">Tell us what your team is solving. We’ll bring the right questions and a practical place to begin.</p><div className="mt-9 flex flex-col gap-4"><a href="mailto:sysprotechnologies@gmail.com" className="flex w-fit items-center gap-3 text-sm font-bold text-[hsl(var(--primary-foreground))] transition-opacity hover:opacity-65" data-testid="link-contact-email"><span className="grid h-9 w-9 place-items-center rounded-full bg-[hsl(var(--primary-foreground)/.12)]"><Mail size={16} /></span>sysprotechnologies@gmail.com</a><a href="tel:+919800284320 / +918584821426" className="flex w-fit items-center gap-3 text-sm font-bold text-[hsl(var(--primary-foreground))] transition-opacity hover:opacity-65" data-testid="link-contact-phone"><span className="grid h-9 w-9 place-items-center rounded-full bg-[hsl(var(--primary-foreground)/.12)]"><Phone size={16} /></span>+91 98311 34162</a></div></motion.div>
